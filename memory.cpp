...
uintptr_t _nt_memory::find_module(const wchar_t* name)
{
...
uintptr_t _nt_memory::find_export(uintptr_t module, const char* name)
{
    uintptr_t a0;
    uint32_t  a1[4], a2[30];
...
NTSTATUS _nt_memory::read(uintptr_t address, void* buffer, size_t length)
{
    return NtReadVirtualMemory(_handle, (PVOID)address, buffer, length, 0);
}

NTSTATUS _nt_memory::write(uintptr_t address, void* buffer, size_t length)
{
